...
var texture_filenames_to_load = [ "stars.png", "text.png", "earth.gif", "ground.png", "gb_player.jpg",
                                 "texture.jpg", "lace.jpg", "downmarker.jpg", "lions.png", "dt_player.jpg", "ref.png" ];
...
function GL_Context( canvas_id )
	{																// Special WebGL-only Initialization
		...
		{	
            ...
            this.FOOTBALL_loc 	= gl.getUniformLocation(program, "FOOTBALL");
		}
